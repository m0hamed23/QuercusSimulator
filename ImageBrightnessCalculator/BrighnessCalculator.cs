...
//    private const string OutputPathFormat = @"D:\frames\currentimage{0}.jpg";
...
//        int[] exposureTimes = { 100000, 75000, 100000, 125000, 150000, 175000, 200000, 225000, 250000, 275000 };
//        int[] ids = { 120, 122, 124, 126, 128, 130, 132, 134, 136, 138 };
...
//                for (int i = 0; i < 10; i++)
//                {
//                    string outputPath = string.Format(OutputPathFormat, i + 1);
...
//                    Console.WriteLine($"Image {i + 1} saved to {outputPath}");

//                    double brightness = CalculateImageBrightness(outputPath);
//                    Console.WriteLine($"Average brightness of {outputPath}: {brightness:F4}");
...
//    private static double CalculateImageBrightness(string imagePath)
//    {
//        using (Image<Rgba32> image = SixLabors.ImageSharp.Image.Load<Rgba32>(imagePath))
//        {
//            double totalBrightness = 0;
