...
//    {
//        private static readonly string _filePath = "C:\\LPR\\SimulatorConfig.json"; // Hardcoded JSON file path
...
//                else
//                {
//                    Log.Information("JSON file does not exist. Returning default IP and Port.");
//                }
//            }
//            catch (Exception ex)
//            {
